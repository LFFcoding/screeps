var roleUpgrader2 = {
    ...
    /** @param {Creep} creep **/
    run: function (creep) {
        if (creep.room == creep.memory.roomWork && creep.pos.x > 0 && creep.pos.y > 0 && creep.pos.x < 49 && creep.pos.y < 49) {
            ...
            creep.moveTo(new RoomPosition(25, 25, creep.memory.roomWork.name))
        }
    }
}
