var roleExplorer1 = {
    ...
    run: function (creep) {
        ...
        if (creep.memory.operacao == 'vazio') {
            if (creep.room == Game.rooms['W3N9'] && creep.pos.x < 49) {
            ...
            } else if (creep.room != Game.rooms['W3N9'] || creep.pos.x >= 49) {
                creep.moveTo(new RoomPosition(46, 24, 'W3N9'))
            }
        } else if (creep.memory.operacao == 'carregado') {
            if (creep.room == Game.rooms['W2N9'] && creep.pos.x > 0) {
            ...
            } else if (creep.room != Game.rooms['W2N9'] || creep.pos.x <= 0) {
                creep.moveTo(new RoomPosition(2, 28, 'W2N9'))
            }
        }
    }
};
